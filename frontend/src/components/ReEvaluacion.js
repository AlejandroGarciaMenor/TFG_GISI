    ...
    return (
        <div className="re-evaluacion-container">
            ...
            <button className="boton-reevaluacion" onClick={() => window.location.href = "/cribado"}>
                Quiero hacer los cuestionarios y hablar con Serena.
            </button>
        </div>
    );
}
